...
const categories = {
  ...
  Function: [
    ...
    {
      name: "Adjuvant",
      desc: "Boosts immune response in vaccine and drug formulations.",
      icon: "/ICONS/Adjuvant.png",
    },
    {
      name: "Anti-bacterial",
    ...
    {
      name: "Anti-Fungal",
      desc: "Protects formulations against fungal contamination.",
      icon: "/ICONS/Antifungal.png",
    },
    {
  ...
  "Labelling Claims": [
    {
      name: "USP",
      desc: "Complies with U.S. Pharmacopoeia quality standards.",
      icon: "/ICONS/USP.png",
    },
    {
      name: "NF",
      desc: "Meets National Formulary pharmaceutical grade requirements.",
      icon: "/ICONS/NF.png",
    },
    {
      name: "EP",
      desc: "European Pharmacopoeia-compliant excipient quality standards.",
      icon: "/ICONS/EP.png",
    },
    {
      name: "Ph. Eur.",
      desc: "Ensures high European Pharmacopoeia compliance.",
      icon: "/ICONS/Ph.Eur..png",
    },
    {
      name: "BP",
      desc: "British Pharmacopoeia-certified for pharmaceutical use.",
      icon: "/ICONS/BP.png",
    },
    {
      name: "JP",
      desc: "Adheres to Japanese Pharmacopoeia quality norms.",
      icon: "/ICONS/JP.png",
    },
    {
      name: "ChP",
      desc: "Complies with Chinese Pharmacopoeia requirements.",
      icon: "/ICONS/Chp.png",
    },
    {
      name: "bioCERTIFIED",
  ...
  "Dosage Form": [
    {
      name: "Aerosol",
      desc: "Inhalation based drug delivery system.",
      icon: "/ICONS/Aerosol.png",
    },
    {
      name: "Gel",
      desc: "Provides controlled drug release with smooth application.",
      icon: "/ICONS/Gel.png",
    },
    {
      name: "Liquid",
      desc: "Used in solutions, syrups, and suspensions.",
      icon: "/ICONS/Liquid.png",
    },
    {
      name: "Ophthalmic",
      desc: "Sterile solutions for eye treatments.",
      icon: "/ICONS/Ophthalmic.png",
    },
    {
      name: "Parenteral",
      desc: "Injectable formulations ensuring bioavailability.",
      icon: "/ICONS/Parenteral.png",
    },
    {
      name: "Semi-Solid",
      desc: "Includes creams, ointments, and gels.",
      icon: "/ICONS/Semi-Solid.png",
    },
    {
      name: "Topical",
      desc: "Applied directly to skin for localized effects.",
      icon: "/ICONS/Topical.png",
    },
    {
      name: "Vaccine",
      desc: "Enhances immunization with excipient stability.",
...
export default function App() {
  ...
  return (
    <div className="bg-gradient-to-r py-14 from-white to-[#9d9c9c] h-full w-full overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        <div className="flex flex-col justify-center gap-0 px-1 lg:px-[270px] lg:py-1">
          <div className="flex flex-row items-center gap-2 ">
            ...
            <h1 className="text-4xl font-bold">
              Our <span className="text-[#22604A]">Categories</span>
            </h1>
          </div>

          <p className="text-regular text-[2vh] font-normal py-3 pl-[50px]">
        ...
        <div>
          ...
          <div className="relative z-10 flex flex-col items-center w-full">
            {/* Navbar */}
            <nav className="flex flex-wrap justify-center gap-[83px] p-3 rounded-lg mb-1 backdrop-blur-sm">
              {Object.keys(categories).map((cat) => (
                <button
                  key={cat}
                  className={` sm:px-2 lg:px-4 py-2 text-md font-semibold rounded transition-all ${
                    activeCategory === cat
                      ? "underline underline-offset-[6px] decoration-[#22604A] decoration-1 "
                      : " "
                  }`}
                  onClick={() => {
            ...
            <div className="relative w-full max-w-[77rem] ">
              {/* Previous button */}
              {currentPage > 0 && (
                <button
              ...
              <div
                ref={gridRef}
                className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-[15px] w-fit mx-auto"
              >
                {currentItems.map((item, index) => (
                  <div
                    onMouseEnter={() =>
                      handleMouseEnter(item.Bgimage, item.name)
                    }
                    onMouseLeave={handleMouseLeave}
                    key={index}
                    className={`border-1 m-0 rounded-lg flex justify-center items-end w-full sm:w-[160px] md:w-[200px] h-[100px] md:h-[118px] border-[#707070] p-[9px] hover:bg-[#2A8D70] hover:shadow-lg cursor-pointer  transition-all duration-300 ${
                      activeContainer === item.name
                        ? "bg-[#2A8D70]"
                        : "bg-[#9dcdbf]/90"
                    }`}
                  >
                    <div className="border-1 rounded-lg  w-full h-full flex flex-col items-center justify-end gap-2 bg-white shadow-md transition-transform duration-500 py-[10px] px-3">
                      <div className="flex flex-row items-center w-full gap-1">
                        ...
                        <div className="flex flex-col items-start">
                          ...
                          <div className="w-[70px] border-b border-b-neutral-400 border-0.5"></div>
                        </div>
                      </div>
                      <p className="text-[8px] font-normal  text-black text-start ">
                        {item.desc}
                      </p>
                    </div>
                  </div>
